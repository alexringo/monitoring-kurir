...
/**
 * Created by Me on 18/04/2016.
 */
public class Config {
    //URL to our login.php file
    public static final String LOGIN_URL = "http://10.0.2.2/distributor-obat/android/login.php";
    public static final String GCM_URL = "http://10.0.2.2/distributor-obat/android/update.php";
    public static final String SELECT_URL = "http://10.0.2.2/distributor-obat/android/select.php";
